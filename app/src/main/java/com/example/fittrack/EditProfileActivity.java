...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private String saveImageToInternalStorage(Uri uri) {
        ...
        try (java.io.InputStream inputStream = getContentResolver().openInputStream(uri);
            ...
            java.io.File[] files = getFilesDir().listFiles((dir, name) -> name.startsWith("profile_pic_"));
            if (files != null) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.ivProfilePic.setOnClickListener(v -> pickImage.launch("image/*"));
        binding.ivCamera.setOnClickListener(v -> pickImage.launch("image/*"));
        ...
        binding.btnSave.setOnClickListener(v -> {
            ...
            preferenceManager.saveProfile(name, email, phone, weight, height);
    ...
    private void loadUserData() {
        ...
        binding.etPhone.setText(preferenceManager.getUserPhone());
        binding.etWeight.setText(String.valueOf(preferenceManager.getCurrentWeight()));
        binding.etHeight.setText(String.valueOf((int) preferenceManager.getUserHeight()));

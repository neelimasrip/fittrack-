...
public class DietData {
    ...
    public static List<DayPlan> getRotationalPlans() {
        ...
        // Day 4: South Indian Fusion
        plans.add(new DayPlan("Day 4 - South Indian",
            new Meal("Moong Dal Chilla & Green Chutney", 260, "https://images.unsplash.com/photo-1604152135912-04a002e75696?w=800"),
        ...
        plans.add(new DayPlan("Day 5 - North Indian",
            ...
            new Meal("Palak Paneer with Whole Wheat Roti", 360, "https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?w=800"),
        ...
        plans.add(new DayPlan("Day 6 - Keto Energy",
            ...
            new Meal("Garlic Butter Broccoli & Cheese", 390, "https://images.unsplash.com/photo-1540420773420-3366772f4999?w=800"),
            new Meal("Roasted Pumpkin & Sunflower Seeds", 140, "https://images.unsplash.com/photo-1511067007398-7e4b90cfa4bc?w=800")
        ));

        // Day 7: Mediterranean Reset
        plans.add(new DayPlan("Day 7 - Mediterranean",
            new Meal("Berry Smoothie Bowl & Almonds", 270, "https://images.unsplash.com/photo-1488477181946-6428a0291777?w=800"),
            new Meal("Mediterranean Chickpea Quinoa Salad", 400, "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800"),
            new Meal("Olive Oil Roasted Veggie Wrap", 340, "https://images.unsplash.com/photo-1547592166-23ac45744acd?w=800"),

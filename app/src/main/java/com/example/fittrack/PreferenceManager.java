...
public class PreferenceManager {
    ...
    public String getMealImage(String type) {
        switch (type) {
            case "Breakfast": return prefs.getString(KEY_MEAL_BREAKFAST_IMG, "https://images.unsplash.com/photo-1604152135912-04a002e75696?w=400");
            case "Lunch": return prefs.getString(KEY_MEAL_LUNCH_IMG, "https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=400");
            case "Dinner": return prefs.getString(KEY_MEAL_DINNER_IMG, "https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=400");
